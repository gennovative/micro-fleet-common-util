...
declare module 'back-lib-common-util/dist/app/BigIdGenerator' {
	...
	export class BigIdGenerator {
	     ...
	     */
	    next(): Int64;
	    wrap(value: string, radix?: number): Int64;
	    wrap(buf: Buffer): Int64;
	    wrap(value?: number): Int64;
	}
...
declare module 'back-lib-common-util' {
	export * from 'back-lib-common-util/dist/app/BigIdGenerator';
